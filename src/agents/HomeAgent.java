        ...
        return new OneShotBehaviour() {
            ...
            public void action() {
                try {
                    ...
                    fireStatusChangedEvent(new HomeStatusContainer(getCurrentNetConsumption(), totalSpendToDate,
                            hourOfDay, dayOfWeek, weeksElapsed,
                            currentEnergyContract, graphScoresPrediction));
